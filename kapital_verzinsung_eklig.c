...
int main()
{    printf("Startkapital: ");
               float startkapital;scanf("%f", &startkapital);

    printf("Zielkapital: ");
    float zielkapital;    scanf("%f", &zielkapital);
    ...
    int jahr = 0;
    while (kapital < zielkapital) {        jahr = jahr + 1;        kapital = kapital + kapital*(zinssatz/100.0);        printf("Jahr: %d --> %f\n", jahr, kapital);    }
